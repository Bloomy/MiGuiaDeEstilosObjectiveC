...
### Formateo
Para formatear el código usaré la herramienta Uncrustify. En Github están colgadas [**mis reglas de estilo actuales**](https://gist.github.com/Bloomy/5705746). La mayoría de ellas fueron descritas en las guías de [Apple](https://developer.apple.com/library/mac/documentation/Cocoa/Conceptual/CodingGuidelines/CodingGuidelines.html) y [Google](http://google-styleguide.googlecode.com/svn/trunk/objcguide.xml). Al respecto, algunas anotaciones:
